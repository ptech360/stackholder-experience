...
var AuditsComponent = (function () {
    function AuditsComponent(as, fb) {
        this.as = as;
        this.fb = fb;
        this.units = [];
        this.audits = [];
    ...
    AuditsComponent.prototype.loadEditForm = function () {
        return this.fb.group({
            touchpoint: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required],
            experience: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]
        });
    };
    AuditsComponent.prototype.loadEditFormData = function (data, touchpoints, index) {
    ...
    AuditsComponent.prototype.submitEditForm = function () {
        var _this = this;
        this.as.updateTouchPoint(this.selectedTouchpoint.touchpointId, this.editForm.value).subscribe(function (response) {
            _this.selectedTouchpoint.touchpoint = _this.editForm.controls["touchpoint"].value;
            _this.selectedTouchpoint.experience = _this.editForm.controls["experience"].value;
            $('#editModal').modal('hide');
        });
    };
    AuditsComponent.prototype.deleteTouchpoint = function () {
        var _this = this;
        if (confirm("Are You Sure you want to Delete this touch point???"))
            this.as.deleteTouchPoint(this.selectedTouchpoint.touchpointId).subscribe(function (response) {
                _this.selectedTouchPoints.splice(_this.selectedTouchpointIndex, 1);
            });
    };
    ...
    AuditsComponent.prototype.getAuditsByUnit = function (unitId) {
        var _this = this;
        this.as.getAuditsByUnit(unitId).subscribe(function (response) {
            if (response.status == 204) {
                _this.audits = [];
            }
            else {
...
AuditsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__audits_service__["a" /* AuditService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__audits_service__["a" /* AuditService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */]) === "function" && _b || Object])
], AuditsComponent);
...
var AuditService = (function () {
    ...
    AuditService.prototype.getAuditsByUnit = function (unitId) {
    ...
    AuditService.prototype.updateTouchPoint = function (tpId, data) {
        return this.http.put("https://hamdan-nxtlife.ind-cloud.everdata.com/api/employee/csa/touchpoint/" + tpId, data)
            .map(this.extractData)
            .catch(this.handleError);
    };
    AuditService.prototype.deleteTouchPoint = function (tpId) {
